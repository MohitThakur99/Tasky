 ...
 <div class="col-md-6 col-lg-4 >
  <div class="card">
    <div class="card-header d-flex justify-content-end gap-2">
     <button type="button" id=${taskData.id} class="btn btn-outline-success" onclick="editCard.apply(this, arguments)"><i class="fas fa-trash" id=${taskData.id} onclick="editCard.apply(this, arguments)"><i class="fas fa-pencil-alt" id=${taskData.id} onclick="editCard.apply(this, arguments)"></i></button>
     <button type="button" class="btn btn-outline-danger" id=${taskData.id} onclick="editCard.apply(this, arguments)"><i class="fas fa-trash" id=${taskData.id} onclick="editCard.apply(this, arguments)"></i></button>
    </div>
...
const editCard = (event) => {
  ...
  if(tagname === "BUTTON"){
    parentEement = event.target.parentNode.parentNode;
  }else{
    parentEement = event.target.parentNode.parentNode.parentNode;
  }

  let taskTitle = parentEement.childNodes[5].childNodes[1];
  let taskTDescription = parentEement.childNodes[5].childNodes[3];
  let tasktype = parentEement.childNodes[5].childNodes[5];
